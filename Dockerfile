...
RUN dnf install -y mingw64-gcc-c++ mingw64-gcc-gfortran cmake doxygen texlive-scheme-full graphviz lapack-devel openmpi python3-numpy python3-matplotlib fftw-devel boost-devel gsl-devel libtiff-devel eigen3-devel python3-devel yaml-cpp-devel python3-yaml python3-PyYAML PyYAML latexmk
